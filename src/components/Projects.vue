...
<script>
  ...
  export default {
    ...
    data: function () {
      return {
        projects: [
          { name: 'TamaLife', img: 'tamalife', youtube: '', website: 'https://tamalife.jonnyhtyson.com', github: 'https://github.com/aethalas/TamaLife', desc: 'Virtual Pet | Unity & C#', about: '<p><b>TamaLife</b> is a virtual pet based on the classic Tamagotchi we all know and love from the 90s.</p> <p>This game is built using the Unity3D game engine and is written in the C# language, primarily as a passion project, but also be released on the Google Play Store upon its completion as the first game released under <b>Fluff ‘n’ Howl Studios</b>.</p> <p>TamaLife has been designed with simplicity in mind: don’t expect anything revolutionary here! The game logic consists of real-world statistical change over time, with the pet needing to be cared for on a regular basis by the user to keep alive. It’s various attributes such as happiness, energy and intellect, are changed over-time and need the user to ensure it keeps these attributes at a healthy level to allow the Tama to grow into adulthood.</p> <p>All illustrations and sound design in this game were designed by my wife, Kaling Tyson.</p> '  },
